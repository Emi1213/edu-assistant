...
export const API_ROUTES = {
    ...
    PAGES: {
        ...
        CREATE_CONCEPT: (pageId: number) => `${AR_KEYS.LEARNING_OBJECTS}/${pageId}/concepts`,
        NOTES: {
        ...
        STUDENT_QUESTIONS: {
            CREATE: `${AR_KEYS.PAGES_INTERACTIONS}/student-questions`,
            UPDATE: (id: number) => `${AR_KEYS.PAGES_INTERACTIONS}/student-questions/${id}`,
            DELETE: (id: number) => `${AR_KEYS.PAGES_INTERACTIONS}/student-questions/${id}`,
        },
        QUESTION_REPLIES: {
            CREATE: `${AR_KEYS.PAGES_INTERACTIONS}/question-replies`,
            UPDATE: (id: number) => `${AR_KEYS.PAGES_INTERACTIONS}/question-replies/${id}`,
            DELETE: (id: number) => `${AR_KEYS.PAGES_INTERACTIONS}/question-replies/${id}`,
        },
        FEEDBACKS: {
        ...
        ACTIVITIES: {
            LIST: (pageId: number) => `${AR_KEYS.LEARNING_OBJECTS}/${pageId}/activities`,
            CREATE: (pageId: number) => `${AR_KEYS.LEARNING_OBJECTS}/${pageId}/activities`,
            BY_ID: (pageId: number, activityId: number) => `${AR_KEYS.LEARNING_OBJECTS}/${pageId}/activities/${activityId}`,
        },
    },
    ACTIVITIES: {
