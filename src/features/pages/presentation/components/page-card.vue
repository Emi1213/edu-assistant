...
<template>
  <div
    class="group relative rounded-lg border border-border bg-card overflow-hidden shadow-sm hover:shadow-md transition-all duration-200"
  ...
  >
    ...
    <div class="flex items-center justify-between px-5 pb-5 pt-3 border-t border-border">
      ...
      <div class="flex items-center gap-2">
        <button
          ...
          @click.stop.prevent="onUpdatePage(page)"
        >
          <Pencil class="size-3" />
        ...
        <button
          ...
          @click.stop.prevent="onGenerateRelations(page)"
        >
